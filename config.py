...
BOT_NAME = getenv("BOT_NAME", "- 𝗮𝗟𝗘𝘅 𝗠𝗎𝘀𝗂𝖼 .")
API_ID = int(getenv("API_ID"))
API_HASH = getenv("API_HASH")
OWNER_NAME = getenv("OWNER_NAME", "GGG66")
ALIVE_NAME = getenv("ALIVE_NAME", "- 𝗮𝗟𝗘𝘅 𝗠𝗎𝘀𝗂𝖼 .")
BOT_USERNAME = getenv("BOT_USERNAME", "")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "CXCXX2")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "rvrrrrv")
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/e77857a6510df13b1b2d3.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/tesla0T/Motok23")
